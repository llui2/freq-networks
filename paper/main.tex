...
\end{equation}
The right-hand side is the spectral weight of the edge-incidence direction in that eigenspace. This gives a direct meaning to which edges support an individual graph frequency without selecting an arbitrary basis inside a degenerate eigenspace.
